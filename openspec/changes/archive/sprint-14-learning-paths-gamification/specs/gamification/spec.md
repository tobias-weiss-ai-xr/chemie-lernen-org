...
**Capability:** XP system, achievements/badges, daily check-in streaks
...
Motivate learners through gamification: earn XP by engaging with content, unlock badges for milestones, maintain daily streaks, and visualize progress. All gamification data is stored in `FileBackedSessionStore` under `user.progress`.

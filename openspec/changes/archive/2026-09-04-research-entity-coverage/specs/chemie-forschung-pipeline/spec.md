# Capability: chemie-forschung-pipeline

The Chemie-Forschung research pipeline MUST progressively cover the knowledge
graph instead of regenerating the same hottest entities every run.

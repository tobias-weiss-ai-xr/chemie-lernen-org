...
| Lehrplan + Didaktik (curricula) | `lehrplan-curriculum/spec.md`       | Active (ZPD: bloom index + objective state)    | Sisyphus | sprint-d-import (15 states + 5 KMK guidelines imported) |
...
| Learning Paths & Gamification   | `learning-paths/spec.md`            | Active (ZPD-aware next-objective requirements) | Sisyphus | sprint-23-learning-paths-gamification                   |
...
| zpd-deepdive-peer-collaboration   | 13/13 | ✓ Complete (implemented 2026-09-16)                               |
...
| ---------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| bloom-zpd-adaptive-engine (→ 2026-09-12) | ux10 fleet         | 21/21 ✓ — Scripts live (backfill/seed = No-op bis Quelldaten blooms_level/Assessments liefern); Specs +6 Requirements gesynced |

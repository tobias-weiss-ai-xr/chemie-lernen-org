...
| Themenbereiche (subject areas)  | `themenbereiche/spec.md`           | Active | Sisyphus | sprint-9-specs-and-fixs                                 |
...
| `sprint-38-premium-lesson-plans` | Shipped | KI lesson plan + worksheet endpoints, /premium/lehrplaene/ |
...
| sprint-33-lehrenden-premium             | 16/16 tasks ✓      | Archived 2026-07-25 (Stripe, gating, badges, overlays)       |
| sprint-34-platform-performance          | 16/16 tasks ✓      | Archived 2026-07-25 (build perf, Lunr search, PWA offline)   |
...
directories. Kept for historical reference. See `README.md` for the mapping.

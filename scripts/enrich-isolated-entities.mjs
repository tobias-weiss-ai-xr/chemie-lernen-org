...
const CURATED = [
  ...
  // API-isolierte Entities (weitere 12)
  ['Barium', 'Periodensystem', 'RELATED_TO'],
  ['Brom', 'Periodensystem', 'RELATED_TO'],
  ['Barium', 'Calcium', 'AEHNLICH_ZU'],
  ['Brom', 'Chlor', 'AEHNLICH_ZU'],
  ['Brom', 'Fluor', 'AEHNLICH_ZU'],
  ['Ethen (C2H4)', 'Alkene', 'RELATED_TO'],
  ['Ethen (C2H4)', 'Alkane', 'RELATED_TO'],
  ['Ethin (C2H2)', 'Alkine', 'RELATED_TO'],
  ['Ethen (C2H4)', 'Ethin (C2H2)', 'AEHNLICH_ZU'],
  ['Löslichkeit', 'Hydratation', 'RELATED_TO'],
  ['Löslichkeit', 'Solvatisierung', 'RELATED_TO'],
  ['Polystyrol (PS)', 'Polymerisation', 'RELATED_TO'],
  ['Polystyrol (PS)', 'duromere', 'AEHNLICH_ZU'],
  ['Saccharose (C12H22O11)', 'Glukose (C6H12O6)', 'RELATED_TO'],
  ['Zersetzung', 'Dissoziation', 'RELATED_TO'],
  ['Zersetzung', 'Hydrolyse', 'RELATED_TO'],
  ['Duennschichtchromatographie', 'Chromatographie', 'RELATED_TO'],
  ['Papierchromatographie', 'Chromatographie', 'RELATED_TO'],
  ['Duennschichtchromatographie', 'Papierchromatographie', 'AEHNLICH_ZU'],
  ['Eisensulfid (FeS)', 'Eisen', 'RELATED_TO'],
  ['Eisensulfid (FeS)', 'Schwefel', 'RELATED_TO'],
  // Letzte API-isolierte
  ['Zinn', 'Zink', 'AEHNLICH_ZU'],
  ['Zinn', 'Kupfer', 'AEHNLICH_ZU'],
  ['biodiesel', 'methanol', 'RELATED_TO'],
  ['biodiesel', 'Treibhausgase', 'RELATED_TO'],
  ['ketone', 'Carbonylverbindungen', 'RELATED_TO'],
  ['molekülorbitale', 'Kovalente Bindung', 'RELATED_TO'],
  ['molekülorbitale', 'Hybridisierung', 'RELATED_TO'],
];

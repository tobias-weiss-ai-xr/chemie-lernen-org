...
const THEMENBEREICHE_KEYWORDS = {
  'einfuehrung-chemie': {
    name: 'Einführung in die Chemie',
    keywords: ['stoff', 'element', 'verbindung', 'gemisch', 'trennverfahren', 'messen', 'einheit', 'labor', 'sicherheit', 'molekül', 'atom', 'zustand', 'aggregat', 'phasenübergang'],
  },
  'aufbau-materie': {
    name: 'Aufbau der Materie',
    keywords: ['atom', 'elektron', 'proton', 'neutron', 'kern', 'schale', 'orbital', 'isotop', 'ionen', 'elektronenkonfiguration', 'quantenzahl', 'atommodell', 'bohr', 'rutherford', 'bindungsenergie', 'ionisierungsenergie'],
  },
  'energetik': {
    name: 'Energetik',
    keywords: ['energie', 'enthalpie', 'enthalpi', 'entropi', 'exotherm', 'endotherm', 'kalorimetri', 'hess', 'reaktionswärme', 'bildungsenthalpie', 'verbrennungsenthalpie', 'gibbs', 'aktivierungsenergie'],
  },
  'saeuren-basen': {
    name: 'Säuren und Basen',
    keywords: ['säure', 'base', 'saeure', 'basen', 'ph-wert', 'ph-', 'neutralisation', 'neutralis', 'puffer', 'indikator', 'titration', 'titrat', 'proton', 'oxonium', 'dissoziation', 'pks', 'pka', 'laug', 'alkali'],
  },
  'redox-elektrochemie': {
    name: 'Redox und Elektrochemie',
    keywords: ['oxidation', 'reduktion', 'redox', 'elektrochemi', 'galvanisch', 'elektrolys', 'korrosion', 'elektrode', 'zelle', 'spannung', 'potential', 'strom', 'kathode', 'anode', 'ladung', 'elektronenübertragung', 'oxidationszahl', 'oxidations'],
  },
  'gleichgewicht-geschwindigkeit': {
    name: 'Gleichgewicht und Kinetik',
    keywords: ['gleichgewicht', 'kinetik', 'geschwindigkeit', 'reaktionsgeschwindigkeit', 'katalysator', 'le chatelier', 'equilibrium', 'ratenkonstante', 'halbwertszeit', 'prinzip', 'verschiebung', 'ordnung'],
  },
  'erdoel-organische-stoffklassen': {
    name: 'Erdöl und Organische Stoffklassen',
    keywords: ['kohlenwasserstoff', 'alkan', 'alken', 'alkin', 'aromat', 'benzol', 'erdoel', 'erdöl', 'petrol', 'funktionelle gruppe', 'alkohol', 'ether', 'carbonsäur', 'ester', 'amin', 'halogenalkan'],
  },
  'reaktionstypen-organisch': {
    name: 'Reaktionstypen der Organischen Chemie',
    keywords: ['substitution', 'nukleophil', 'elektrophil', 'addition', 'eliminierung', 'kondensation', 'polymerisation', 'veresterung', 'hydrierung', 'dehydratisierung', 'oxidation organis', 'reduktion organis'],
  },
  'produkte-organisch': {
    name: 'Organische Produkte im Alltag',
    keywords: ['kunststoff', 'polymer', 'plastik', 'kunstfaser', 'farbstoff', 'pigment', 'aroma', 'duftstoff', 'waschmittel', 'tensid', 'seife', 'kosmetik', 'klebstoff', 'lack', 'pharma'],
  },
  'anorganische-verbindungen': {
    name: 'Anorganische Verbindungen',
    keywords: ['metall', 'nichtmetall', 'halogen', 'edelgas', 'oxid', 'hydroxid', 'sulfid', 'carbonat', 'nitrat', 'chlorid', 'sulfat', 'phosphat', 'komplex', 'ligand', 'übergangsmetall', 'salz', 'kristall', 'ionengitter'],
  },
  'analytische-methoden': {
    name: 'Analytische Methoden',
    keywords: ['chromatographi', 'spektroskop', 'massenspektrometri', 'nmr', 'ir-spektroskop', 'uv-vis', 'titration', 'gravimetri', 'photometri', 'nachweisreaktion', 'qualitativ', 'quantitativ', 'analytik'],
  },
  'biochemie': {
    name: 'Biochemie',
    keywords: ['enzym', 'protein', 'dna', 'rna', 'nukleinsäur', 'kohlenhydrat', 'zucker', 'fett', 'lipid', 'membran', 'aminosäur', 'biokatalys', 'fermentation', 'photosynthese', 'atp', 'metabol', 'biochemi'],
  },
  'tipps-tricks': {
    name: 'Tipps und Tricks',
    keywords: ['lernen', 'lernstrategi', 'formel', 'gleichung', 'aufgabe', 'prüfung', 'experiment', 'labor', 'fehler', 'tipps'],
  },
};
 ...
 */
function readEntityFrontmatter(filePath) {
...
const entityDirs = fs.readdirSync(ENTITY_DIR, { withFileTypes: true })
...
for (const [tbSlug, tbData] of Object.entries(THEMENBEREICHE_KEYWORDS)) {
  ...
  mapping[tbSlug] = top.map((e) => {
    const normalized = maxScore !== minScore
      ? (e.score - minScore) / (maxScore - minScore)
      : 0.5;

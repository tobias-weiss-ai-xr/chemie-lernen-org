...
const testPages = [
  ...
  '/ki-assistent/',
  '/wissennetz/',
  '/themenbereiche/stoichiometrie/',
  '/themenbereiche/chemische-bindungen/',
  '/themenbereiche/saeuren-basen/',
  '/themenbereiche/elektrochemie/',
  '/themenbereiche/organische-chemie/',
  '/themenbereiche/thermodynamik/',
];
...
for (const url of testPages) {
  try {
    ...
    console.log(
      `${status.padEnd(25)} | ${url.padEnd(50)} | h1="${h1.substring(0, 60)}" | title="${title.substring(0, 60)}"`
    );
  } catch (err) {

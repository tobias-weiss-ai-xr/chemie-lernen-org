...
const elementEmojis = {
    ...
    'Tl': '📊',   'Pb': '🔋',   'Bi': '💜',   'Po': '☢️',   'At': '⚛️',
    'Rn': '💨',   'Fr': '🌹',   'Ra': '💀',   'Ac': '🌟',   'Th': '☢️',
    'Pa': '⚡',   'U': '☢️',    'Np': '☢️',   'Pu': '☢️',   'Am': '☢️',
    'Cm': '☢️',   'Bk': '☢️',   'Cf': '☢️',   'Es': '☢️',   'Fm': '☢️',
    'Md': '☢️',   'No': '☢️',   'Lr': '☢️',   'Rf': '⚛️',   'Db': '⚛️',
    'Sg': '⚛️',   'Bh': '⚛️',   'Hs': '⚛️',   'Mt': '⚛️',   'Ds': '⚛️',
    'Rg': '⚛️',   'Cn': '⚛️',   'Nh': '⚛️',   'Fl': '⚛️',   'Mc': '⚛️',
    'Lv': '⚛️',   'Ts': '⚛️',   'Og': '⚛️'
};

const table = [
    'H', 'Wasserstoff', '1.00794', 1, 1,
    'He', 'Helium', '4.002602', 18, 1,
    'Li', 'Lithium', '6.941', 1, 2,
    'Be', 'Beryllium', '9.012182', 2, 2,
    'B', 'Bor', '10.811', 13, 2,
    'C', 'Kohlenstoff', '12.0107', 14, 2,
    'N', 'Stickstoff', '14.0067', 15, 2,
    'O', 'Sauerstoff', '15.9994', 16, 2,
    'F', 'Fluor', '18.9984032', 17, 2,
    'Ne', 'Neon', '20.1797', 18, 2,
    'Na', 'Natrium', '22.98976...', 1, 3,
    'Mg', 'Magnesium', '24.305', 2, 3,
    'Al', 'Aluminium', '26.9815386', 13, 3,
    'Si', 'Silizium', '28.0855', 14, 3,
    'P', 'Phosphor', '30.973762', 15, 3,
    'S', 'Schwefel', '32.065', 16, 3,
    'Cl', 'Chlor', '35.453', 17, 3,
    'Ar', 'Argon', '39.948', 18, 3,
    'K', 'Kalium', '39.0983', 1, 4,
    'Ca', 'Calcium', '40.078', 2, 4,
    'Sc', 'Scandium', '44.955912', 3, 4,
    'Ti', 'Titan', '47.867', 4, 4,
    'V', 'Vanadium', '50.9415', 5, 4,
    'Cr', 'Chrom', '51.9961', 6, 4,
    'Mn', 'Mangan', '54.938045', 7, 4,
    'Fe', 'Eisen', '55.845', 8, 4,
    'Co', 'Kobalt', '58.933195', 9, 4,
    'Ni', 'Nickel', '58.6934', 10, 4,
    'Cu', 'Kupfer', '63.546', 11, 4,
    'Zn', 'Zink', '65.38', 12, 4,
    'Ga', 'Gallium', '69.723', 13, 4,
    'Ge', 'Germanium', '72.63', 14, 4,
    'As', 'Arsen', '74.9216', 15, 4,
    'Se', 'Selen', '78.96', 16, 4,
    'Br', 'Brom', '79.904', 17, 4,
    ...
    'Nb', 'Niob', '92.90628', 5, 5,
    'Mo', 'Molybdän', '95.96', 6, 5,
    'Tc', 'Technetium', '(98)', 7, 5,
    'Ru', 'Ruthenium', '101.07', 8, 5,
    'Rh', 'Rhodium', '102.9055', 9, 5,
    'Pd', 'Palladium', '106.42', 10, 5,
    'Ag', 'Silber', '107.8682', 11, 5,
    'Cd', 'Cadmium', '112.411', 12, 5,
    'In', 'Indium', '114.818', 13, 5,
    'Sn', 'Zinn', '118.71', 14, 5,
    'Sb', 'Antimon', '121.76', 15, 5,
    'Te', 'Tellur', '127.6', 16, 5,
    'I', 'Iod', '126.90447', 17, 5,
    'Xe', 'Xenon', '131.293', 18, 5,
    'Cs', 'Cäsium', '132.9054', 1, 6,
    'Ba', 'Barium', '132.9054', 2, 6,
    'La', 'Lanthan', '138.90547', 4, 9,
    'Ce', 'Cer', '140.116', 5, 9,
    'Pr', 'Praseodym', '140.90765', 6, 9,
    'Nd', 'Neodym', '144.242', 7, 9,
    ...
    'Ta', 'Tantal', '180.94788', 5, 6,
    'W', 'Wolfram', '183.84', 6, 6,
    'Re', 'Rhenium', '186.207', 7, 6,
    'Os', 'Osmium', '190.23', 8, 6,
    'Ir', 'Iridium', '192.217', 9, 6,
    'Pt', 'Platin', '195.084', 10, 6,
    'Au', 'Gold', '196.966569', 11, 6,
    'Hg', 'Quecksilber', '200.59', 12, 6,
    'Tl', 'Thallium', '204.3833', 13, 6,
    'Pb', 'Blei', '207.2', 14, 6,
    'Bi', 'Wismut', '208.9804', 15, 6,
...
function init() {
    ...
    for ( let i = 0; i < table.length; i += 5 ) {
        ...
        emojiSpan.className = 'emoji-link';
        emojiSpan.textContent = elementEmojis[table[i]] || '⚛️';

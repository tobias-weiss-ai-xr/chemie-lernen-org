...
teilgebiet: ['allgemein', 'ki']
tags: ['ki', 'assistent', 'chat', 'wissen', 'fragen', 'llm', 'multi-turn']
---
...
**Kann ich auf Antworten weiterführende Fragen stellen?**  
Ja! Der Assistent behält bis zu 50 Nachrichten pro Gespräch im Gedächtnis und versteht Kontext aus vorherigen Fragen. Sie können tiefgehend diskutieren und komplexe Themen schrittweise erkunden.

**Was passiert, wenn der LLM nicht weiterweiß?**  
Falls die KI eine Frage nicht beantworten kann, fällt der Assistent automatisch auf unser Wissensnetz zurück und liefert quellenbasierte Antworten aus den Inhalten der Plattform.

**Sind die Antworten immer korrekt?**  
Die LLM-Antworten werden mit unserem Wissensnetz verifiziert. Bei komplexen oder aktuellen Themen empfehlen wir dennoch eine Überprüfung mit den verlinkten Quellen und interaktiven Tools.

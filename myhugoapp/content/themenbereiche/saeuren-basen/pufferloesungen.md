...
Der pH-Wert eines Puffers folgt der **Henderson-Hasselbalch-Gleichung**: $pH = pK_s + \log\frac{[Base]}{[Säure]}$. Solange das Konzentrationsverhältnis in der Größenordnung 10:1 bis 1:10 bleibt, ist der Puffer wirksam.

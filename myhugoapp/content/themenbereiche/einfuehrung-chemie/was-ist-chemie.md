...
2.  Liegt in den folgenden Fällen eine chemische Reaktion oder ein physikalischer Vorgang vor? Begründe:
    - (a) Zucker löst sich in Wasser
    - (b) Ein Eisenblech rostet
    - (c) Wasser gefriert zu Eis
    - (d) Ein Holzstück verbrennt zu Asche

3.  Gegeben ist die Reaktionsgleichung der Photosynthese:
    $$6\,\ce{CO2} + 6\,\ce{H2O} \xrightarrow{Licht} \ce{C6H12O6} + 6\,\ce{O2}$$
    Benenne die Edukte und die Produkte. Handelt es sich um eine exotherme oder endotherme Reaktion? Begründe die Energiebilanz mithilfe des Energieumsatzes.

4.  Nenne drei Beispiele aus deinem Alltag, bei denen eine chemische Reaktion abläuft, und gib jeweils an, welche Stoffe umgewandelt werden. Ordne jedes Beispiel einer der folgenden Kategorien zu: Kochen/Backen, Körper/Stoffwechsel, Technik/Umwelt.

5.  Das Gesetz der Massenerhaltung (Lavoisier) besagt, dass die Gesamtmasse der Edukte gleich der Gesamtmasse der Produkte ist. Überprüfe dies anhand der Verbrennung von Methan ($\ce{CH4 + 2 O2 -> CO2 + 2 H2O}$) mit folgenden molaren Massen: $M(\ce{CH4})=16{,}05\,\text{g/mol}$, $M(\ce{O2})=32{,}00\,\text{g/mol}$, $M(\ce{CO2})=44{,}01\,\text{g/mol}$, $M(\ce{H2O})=18{,}02\,\text{g/mol}$. Berechne die Gesamtmasse der Edukte und der Produkte für $1\,\text{mol}$ umgesetztes Methan.

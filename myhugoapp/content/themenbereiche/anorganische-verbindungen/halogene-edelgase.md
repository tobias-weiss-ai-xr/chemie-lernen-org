---
title: 'Halogene und Edelgase'
description: 'Gruppe 17 und 18: Trends in der Reaktivität, Halogenaustauschreaktionen, Edelgasverbindungen (XeF₂).'
date: '2026-07-09'
...
icon: '💨'
aliases: [/article/halogene-edelgase/]
---

**Halogene** (Gruppe 17) und **Edelgase** (Gruppe 18) bilden die beiden letzten Hauptgruppen des Periodensystems. Die Halogene zählen zu den reaktivsten Elementen, während Edelgase lange als vollständig reaktionsträge galten – bis 1962 die erste Edelgasverbindung entdeckt wurde.
...
Die Farbe der Lösung zeigt die Reaktion an: Brom färbt orange-braun, Iod braun-violett.
...
- $\ce{AgCl}$: weiß, löslich in $\ce{NH3}$
...
$\ce{XeF2}$ ist ein weißer Feststoff und ein starkes Oxidationsmittel:

$$\ce{2 XeF2 + 2 H2O -> 2 Xe + 4 HF + O2}$$

Die Bildung ist möglich, weil Xenon mit 1170 kJ/mol die niedrigste Ionisierungsenergie der stabilen Edelgase besitzt. Krypton bildet ebenfalls Verbindungen ($\ce{KrF2}$), jedoch deutlich schwerer. Helium und Neon reagieren unter Normalbedingungen nicht.
...
Die entstehende unterchlorige Säure ($\ce{HOCl}$) wirkt stark oxidierend und tötet Bakterien ab.

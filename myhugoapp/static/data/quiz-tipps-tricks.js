  ...
  questions: [
    {
      ...
      correctAnswer: 1,
      explanation:
        'OIL RIG: Oxidation Is Loss (Elektronenverlust), Reduction Is Gain (Elektronengewinn). Oxidation = Elektronen abgeben, Reduktion = Elektronen aufnehmen.',
    },
    {
      id: 2,
      type: 'multiple-choice',
      ...
      correctAnswer: 0,
      explanation:
        'OPFER: O=-2 (Sauerstoff), P=+1 bis +5 (je nach Bindung), F=-1 (Fluor), E=0 (Elemente), R=Ionenladung (einfache Ionen).',
    },
    {
      id: 3,
      type: 'true-false',
      question:
        'Nach der Ebbinghaus-Vergessenskurve sind nach 1 Woche etwa 80% des gelernten Materials vergessen.',
      options: ['Wahr', 'Falsch'],
      correctAnswer: 0,
      explanation:
        'Richtig! Die Ebbinghaus-Vergessenskurve zeigt: Nach 1 Stunde 60%, nach 1 Tag 70%, nach 1 Woche 80% vergessen. Spaced Repetition hilft dagegen.',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Die Lehrer-Methode: Stellen Sie sich vor, Sie müssen das Thema jemand anderem erklären. Wenn Sie es nicht einfach erklären können, haben Sie es noch nicht verstanden.',
    },
    {
      id: 5,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Kat**ionen** = **Katzen** = **positiv** (Katzen schnurren positiv). **An**ionen = **A**ngst = **negativ** (Angst ist negativ).',
    },
    {
      id: 6,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Ein häufiger Fehler: pH = -log[OH-] ist falsch! Für Basen erst pOH berechnen, dann pH = 14 - pOH verwenden.',
    },
    {
      id: 7,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'SMART-Ziele: Spezifisch (konkret), Messbar (überprüfbar), Attribuiert (eigene Anstrengung), Realistisch (machbar), Terminiert (mit Frist).',
    },
    {
      id: 8,
      type: 'true-false',
      ...
      correctAnswer: 1,
      explanation:
        'Falsch! Ein Katalysator beschleunigt Hin- und Rückreaktion gleichermaßen. Er erreicht das Gleichgewicht schneller, verschiebt es aber nicht.',
    },
    {
      id: 9,
      type: 'multiple-choice',
      ...
      correctAnswer: 0,
      explanation:
        "Die korrekte Reihenfolge: Methan (C1), Ethan (C2), Propan (C3), Butan (C4), Pentan (C5), Hexan (C6). Merkspruch: 'Meine Esel brüllen nie laut'.",
    },
    {
      id: 10,
      type: 'multiple-choice',
      question:
        'Was ist bei der Prüfungsvorbereitung in der letzten Phase (1 Tag vor der Prüfung) zu tun?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'In der letzten Phase nur noch wiederholen, nichts Neues lernen. Leichte Aufgaben zur Beruhigung lösen und früh schlafen gehen.',
    },
    {
      id: 11,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Spaced Repetition: Sofort nach 10 Minuten, dann nach 1 Tag, nach 3 Tagen und nach 1 Woche wiederholen. Dies bekämpft die Vergessenskurve effektiv.',
    },
    {
      id: 12,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Ein häufiger Fehler: Einheiten vergessen! Richtig ist: n = (5 g) / (58.44 g/mol) = 0.086 mol. Die Einheiten müssen mit angegeben werden.',
    },
    {
      id: 13,
      type: 'true-false',
      ...
      correctAnswer: 1,
      explanation:
        'Falsch! 250 mL = 0.250 L (nicht 250 L). 1 L = 1000 mL, also durch 1000 teilen: 250 / 1000 = 0.25.',
    },
    {
      id: 14,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Laugen (Basen) färben Lackmuspapier blau (lila-blau), Säuren färben Lackmuspapier rot. Dies ist ein wichtiger Indikator für den pH-Wert.',
    },
    {
      id: 15,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        "Effektive Strategie: Falsche Antworten ausschließen. Auf absolute Wörter wie 'immer', 'nie', 'alle' achten (meist falsch!). Alle Antworten lesen.",
    },
  ],
};

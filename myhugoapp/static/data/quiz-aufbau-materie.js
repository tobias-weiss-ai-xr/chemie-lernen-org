  ...
  questions: [
    {
      ...
      correctAnswer: 0,
      explanation:
        'Atome bestehen aus Protonen (positiv), Neutronen (neutral) im Kern und Elektronen (negativ) in der Hülle.',
    },
    {
      id: 2,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Die Ordnungszahl (Protonenzahl Z) bestimmt das Element. Jedes Element hat eine eindeutige Protonenzahl.',
    },
    {
      id: 3,
      type: 'multiple-choice',
      ...
      correctAnswer: 3,
      explanation:
        'Die Massenzahl A = Protonenzahl + Neutronenzahl. Bei Kohlenstoff-12: A = 6 + 6 = 12.',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 2,
      explanation:
        'Niels Bohr führte 1913 das Konzept der diskreten Elektronenbahnen (Schalen) ein, auf denen Elektronen ohne Energieabgabe kreisen.',
    },
    {
      id: 5,
      type: 'true-false',
      ...
      correctAnswer: 0,
      explanation:
        'Richtig! Bei der Ionenbindung gibt ein Metall Elektronen ab (Kation) und ein Nichtmetall nimmt sie auf (Anion).',
    },
    {
      id: 6,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Isotope sind Atome desselben Elements (gleiche Protonenzahl) mit unterschiedlicher Neutronenzahl.',
    },
    {
      id: 7,
      type: 'multiple-choice',
      ...
      correctAnswer: 3,
      explanation:
        'Edelgase (Gruppe 18) sind sehr reaktionsträge due zu ihrer vollbesetzten äußeren Elektronenschale.',
    },
    {
      id: 8,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Bei der Atombindung werden Elektronenpaare gemeinsam genutzt (z.B. H-H, H-O-H).',
    },
    {
      id: 9,
      type: 'fill-blank',
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'Sauerstoff hat in meisten Verbindungen die Oxidationszahl -2 (Ausnahmen: Peroxide mit -1).',
    },
  ],
};

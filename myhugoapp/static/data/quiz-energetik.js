...
const quizData_energetik = {
  ...
  questions: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Die Reaktionsenthalpie ΔH ist die Änderung der Enthalpie bei einer Reaktion bei konstantem Druck.',
    },
    {
      id: 3,
      type: 'true-false',
      ...
      correctAnswer: 0,
      explanation:
        'Richtig! Der Hesssche Satz besagt, dass die Reaktionsenthalpie unabhängig vom Reaktionsweg ist.',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 2,
      explanation:
        'Die Aktivierungsenergie Ea ist die Energiedifferenz zwischen Reaktanden und dem Übergangszustand.',
    },
    {
      id: 5,
      type: 'multiple-choice',
      ...
      correctAnswer: 2,
      explanation:
        'Eine Reaktion ist spontan, wenn ΔG < 0. ΔG = ΔH - T·ΔS berücksichtigt Enthalpie und Entropie.',
    },
    {
      id: 6,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Ein Katalysator senkt die Aktivierungsenergie, beschleunigt die Reaktion, wird aber nicht verbraucht.',
    },
    {
      id: 7,
      type: 'fill-blank',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Die Bindungsenthalpie ist die Energie, die benötigt wird, um eine chemische Bindung zu brechen.',
    },
    {
      id: 9,
      type: 'multiple-choice',
    ...
    },
    {
      ...
      options: ['ΔG = ΔH + T·ΔS', 'ΔG = ΔH - T·ΔS', 'ΔG = -ΔH + T·ΔS', 'ΔG = ΔH · T·ΔS'],
      correctAnswer: 1,
      explanation:
        'Die Gibbs-Energie (freie Enthalpie) ist ΔG = ΔH - T·ΔS. Eine Reaktion ist spontan wenn ΔG < 0.',
    },
  ],
};

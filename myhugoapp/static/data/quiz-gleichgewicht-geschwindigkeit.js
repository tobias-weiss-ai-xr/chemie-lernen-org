  ...
  questions: [
    {
      ...
      correctAnswer: 0,
      explanation:
        'Die Reaktionsgeschwindigkeit v = -Δc(Reaktand)/Δt beschreibt, wie schnell sich die Konzentration ändert.',
    },
    {
      id: 2,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        "Die RGT-Regel (Raoult-Guldberg-van't Hoff): Eine Erhöhung um 10 K verdoppelt bis vervierfacht die Geschwindigkeit.",
    },
    {
      id: 3,
      type: 'true-false',
      ...
      correctAnswer: 1,
      explanation:
        'Falsch! Ein Katalysator beschleunigt Hin- und Rückreaktion gleichermaßen, verschiebt also NICHT das Gleichgewicht.',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 0,
      explanation:
        'Le Chatelier: Wenn ein System im Gleichgewicht gestört wird, verschiebt es sich, um die Störung zu kompensieren.',
    },
    {
      id: 5,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Höherer Druck begünstigt die Seite mit weniger Gasmolekülen (z.B. N₂ + 3H₂ ⇌ 2NH₃).',
    },
    {
      id: 6,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Die Aktivierungsenergie Ea ist die minimale Energie, die Reaktanten benötigen, um zu reagieren.',
    },
    {
      id: 7,
      type: 'fill-blank',
      question:
        'Im chemischen Gleichgewicht sind die Geschwindigkeiten von Hin- und Rückreaktion _______.',
      correctAnswer: 'gleich',
      explanation:
        'Im Gleichgewicht ist v(hin) = v(rück). Die Konzentrationen ändern sich nicht mehr (makroskopisch).',
    },
    {
      id: 8,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Bei einer Reaktion erster Ordnung ist die Geschwindigkeit proportional zur Konzentration eines Reaktanden: v = k · c(A).',
    },
    {
      id: 9,
      type: 'multiple-choice',
      ...
      correctAnswer: 3,
      explanation:
        'Druck beeinflusst nur Gasreaktionen (durch Konzentrationsänderung). Bei Feststoffen hat Druck keinen direkten Einfluss.',
    },
    {
      id: 10,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Haber-Bosch: Hoher Druck (200-300 bar) verschiebt Gleichgewicht, mittlere Temperatur (400-500°C) für Geschwindigkeit, Eisen-Katalysator.',
    },
  ],
};

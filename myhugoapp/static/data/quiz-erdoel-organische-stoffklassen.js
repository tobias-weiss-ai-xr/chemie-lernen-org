  ...
  questions: [
    {
      ...
      options: ['Kohlenwasserstoffe', 'Alkohole', 'Säuren', 'Salze'],
      correctAnswer: 0,
      explanation:
        'Erdöl besteht hauptsächlich aus Kohlenwasserstoffen (Alkanen, Cycloalkanen, aromatischen Kohlenwasserstoffen).',
    },
    {
      id: 2,
      type: 'multiple-choice',
      question: 'Welches ist die einfachste organische Verbindung?',
      options: ['Methan (CH₄)', 'Ethan (C₂H₆)', 'Ethen (C₂H₄)', 'Benzol (C₆H₆)'],
      correctAnswer: 0,
      explanation:
        'Methan (CH₄) ist der einfachste Kohlenwasserstoff mit nur einem Kohlenstoffatom.',
    },
    {
      id: 3,
      type: 'true-false',
      ...
      correctAnswer: 0,
      explanation:
        'Richtig! Alkane sind gesättigte Kohlenwasserstoffe mit nur Einfachbindungen (CnH2n+2).',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Alkene sind ungesättigte Kohlenwasserstoffe mit mindestens einer C=C-Doppelbindung. Alkane haben nur Einfachbindungen.',
    },
    {
      id: 5,
      type: 'multiple-choice',
      question: 'Welche funktionelle Gruppe hat die Formel -OH?',
      options: ['Aldehyde', 'Ketone', 'Alkohole', 'Carbonsäuren'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Aromaten sind cyclische Kohlenwasserstoffe mit einem System aus konjugierten Doppelbindungen (z.B. Benzol C₆H₆).',
    },
    {
      id: 7,
      type: 'fill-blank',
      ...
      explanation:
        'Alkane haben die allgemeine Summenformel CnH2n+2 (z.B. Methan CH₄, Ethan C₂H₆, Propan C₃H₈).',
    },
    {
      id: 8,
      type: 'multiple-choice',
      question: 'Welches ist ein wichtiges Produkt der Erdölraffinerie?',
      options: ['Sauerstoff', 'Benzin', 'Wasser', 'Kochsalz'],
      correctAnswer: 1,
      explanation:
        'Benzin ist ein wichtiges Produkt der Erdölraffinerie, gewonnen durch Destillation von Erdöl.',
    },
    {
      id: 9,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Ester entstehen aus der Reaktion einer Carbonsäure mit einem Alkohol (Veresterung). Sie haben die funktionelle Gruppe -COO-.',
    },
    {
      id: 10,
      type: 'multiple-choice',
      question: 'Welches ist die charakteristische Gruppe von Carbonsäuren?',
      options: ['-OH (Hydroxyl)', '-COOH (Carboxyl)', '-CHO (Aldehyd)', '-CO- (Keton)'],
      correctAnswer: 1,
...
if (typeof chemieQuiz !== 'undefined') {
  chemieQuiz.registerQuiz(
    'erdoel-organische-stoffklassen',
    quizData_erdoel_organische_stoffklassen
  );
}

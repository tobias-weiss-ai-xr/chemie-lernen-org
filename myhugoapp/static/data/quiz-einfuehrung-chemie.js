  ...
  questions: [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Die Chemie ist die Lehre vom Aufbau, den Eigenschaften und der Umwandlung der Stoffe sowie den dabei auftretenden Energien.',
    },
    {
      id: 2,
      type: 'true-false',
    ...
    },
    {
      ...
      options: ['Fest', 'Flüssig', 'Gasförmig', 'Kristallin'],
      correctAnswer: 3,
      explanation:
        "Es gibt nur drei Aggregatzustände: fest, flüssig und gasförmig. 'Kristallin' beschreibt eine Struktur, keinen Zustand.",
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 0,
      explanation:
        'Ein chemisches Element ist ein Reinstoff, der durch chemische Methoden nicht in einfachere Stoffe zerlegt werden kann.',
    },
    {
      id: 5,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Eine chemische Verbindung besteht aus Atomen zweier oder mehrerer Elemente, die in einem festen Massenverhältnis verbunden sind.',
    },
    {
      id: 6,
      type: 'multiple-choice',
      question: 'Welches ist ein Beispiel für ein physikalisches Gemisch?',
      options: ['Wasser (H₂O)', 'Kochsalz (NaCl)', 'Luft', 'Sauerstoff (O₂)'],
      correctAnswer: 2,
      explanation:
        'Luft ist ein physikalisches Gemisch aus Stickstoff, Sauerstoff, Kohlendioxid und anderen Gasen. Wasser und Kochsalz sind chemische Verbindungen.',
    },
    {
      id: 7,
      type: 'fill-blank',
      question:
        'Der kleinste Teil eines chemischen Elements, der noch dessen Eigenschaften besitzt, heißt _______.',
      correctAnswer: 'Atom',
      explanation:
        'Atome sind die kleinsten Teilchen eines Elements, die noch dessen chemische Eigenschaften besitzen.',
    },
    {
      id: 8,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Das Gesetz der konstanten Proportionen besagt, dass eine chemische Verbindung stets aus gleichen Massenteilen der Elemente besteht.',
    },
    {
      id: 9,
      type: 'true-false',
      ...
      correctAnswer: 1,
      explanation:
        'Falsch! Bei einer physikalischen Veränderung (z.B. Schmelzen) entstehen keine neuen Stoffe. Erst bei einer chemischen Reaktion entstehen neue Stoffe.',
    },
    {
      id: 10,
      type: 'multiple-choice',
      ...
      correctAnswer: 2,
      explanation:
        "Das Symbol für Gold ist Au (vom lateinischen 'Aurum'). Ag ist Silber, Gd ist Gadolinium.",
    },
  ],
};

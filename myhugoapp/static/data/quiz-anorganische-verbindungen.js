  ...
  questions: [
    {
      ...
      options: ['Nur Salz', 'Nur Wasser', 'Salz und Wasser', 'Säure und Base'],
      correctAnswer: 2,
      explanation:
        'Bei der Neutralisation reagieren Säure und Base zu Salz und Wasser: Säure + Base → Salz + Wasser.',
    },
    {
      id: 2,
      type: 'multiple-choice',
      question: 'Welcher Stoff ist ein starkes Elektrolyt?',
      options: ['Essigsäure (CH₃COOH)', 'Salzsäure (HCl)', 'Kohlensäure (H₂CO₃)', 'Ammoniak (NH₃)'],
      correctAnswer: 1,
      explanation:
        'Salzsäure (HCl) ist eine starke Säure und dissoziiert in Wasser vollständig zu einem starken Elektrolyten.',
    },
    {
      id: 3,
      type: 'true-false',
      ...
      correctAnswer: 0,
      explanation:
        'Richtig! Alle Nitrate (NO₃⁻) sind in Wasser gut löslich, unabhängig vom Kation.',
    },
    {
      id: 4,
      type: 'multiple-choice',
      ...
      correctAnswer: 0,
      explanation:
        'Ein Kation ist ein positiv geladenes Ion (z.B. Na⁺, Ca²⁺, Al³⁺), das durch Abgabe von Elektronen entsteht.',
    },
    {
      id: 5,
      type: 'multiple-choice',
    ...
    },
    {
      ...
      options: ['H-O-H', 'H=O=H', 'H-O-H mit zwei freien Elektronenpaaren am Sauerstoff', 'H≡O≡H'],
      correctAnswer: 2,
      explanation:
        'Wasser (H-O-H) hat zwei freie Elektronenpaare am Sauerstoff, was zu einer gewinkelten Struktur führt.',
    },
    {
      id: 7,
      type: 'fill-blank',
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Komplexe bestehen aus einem Zentralatom (meist Metall) und umgebenden Liganden (Moleküle oder Ionen).',
    },
    {
      id: 9,
      type: 'multiple-choice',
      question: 'Welches Gas entsteht bei der Reaktion von Carbonat mit Säure?',
      options: ['Wasserstoff (H₂)', 'Sauerstoff (O₂)', 'Kohlendioxid (CO₂)', 'Stickstoff (N₂)'],
      correctAnswer: 2,
      explanation:
        'CaCO₃ + 2HCl → CaCl₂ + H₂O + CO₂↑. Carbonate reagieren mit Säuren unter CO₂-Entwicklung.',
    },
    {
      id: 10,
      type: 'multiple-choice',
      ...
      correctAnswer: 1,
      explanation:
        'Das Haber-Bosch-Verfahren synthesiert Ammoniak aus Stickstoff und Wasserstoff: N₂ + 3H₂ ⇌ 2NH₃.',
    },
  ],
};

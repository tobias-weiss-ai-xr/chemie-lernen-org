...
function storeError(err) {
  try {
    ...
    errors.push({
      ...
      url: err.filename || (typeof window !== 'undefined' ? window.location.href : ''),
      line: err.lineno,
      col: err.colno,
...
function showErrorBanner(msg) {
  ...
  banner.style.cssText =
    'position:fixed;bottom:0;left:0;right:0;background:#e74c3c;color:#fff;padding:10px 20px;font-size:14px;z-index:9999;text-align:center;font-family:sans-serif;';
  banner.innerHTML =
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { getStoredErrors, storeError, showErrorBanner, ERROR_STORAGE_KEY };
}

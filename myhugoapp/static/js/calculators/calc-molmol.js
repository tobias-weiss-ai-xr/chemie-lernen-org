...
function calcMolMol() {
  ...
  document.getElementById('mol-calc').innerHTML =
    ...
    n2.toFixed(4) +
    ' mol</p>' +
    '<p class="text-muted"><small>Formel: n\u2082 = n\u2081 \u00d7 (\u03bd\u2082/\u03bd\u2081) = ' +
    n1 +
    ' \u00d7 (' +
    v2 +
    '/' +
    ...
    '<p style="font-family:monospace; color:#1976D2;">Verh\u00e4ltnis = \u03bd\u2082/\u03bd\u2081 = ' +
    v2 +
    '/' +
    v1 +
    ' = ' +
    (v2 / v1).toFixed(4) +
    '</p>' +
    '<p><small>Das bedeutet: F\u00fcr jedes ' +
    v1 +
    ' Mol Edukt entstehen ' +
    v2 +
    ' Mol Produkt.</small></p>' +
    ...
    '<p style="font-family:monospace; color:#1976D2;">n\u2082 = ' +
    n1 +
    ' mol \u00d7 ' +
    (v2 / v1).toFixed(4) +
    ' = ' +
    ...
    n2.toFixed(4) +
    ' mol Produkt werden aus ' +
    n1 +
    ' mol Edukt gebildet.</p>' +
    '</div>' +
    '</div>' +
    '<div style="margin-bottom:15px;">' +

...
function calcYield() {
  ...
  document.getElementById('yield-result').innerHTML =
    ...
    '<p style="font-family:monospace; color:#7B1FA2;">Theoretisch = ' +
    theo +
    ' g</p>' +
    '<p style="font-family:monospace; color:#7B1FA2;">Praktisch = ' +
    act +
    ' g</p>' +
    '</div>' +
    '<div style="background:white; padding:10px; border-radius:4px; margin-bottom:10px;">' +
    '<p><strong>Schritt 2:</strong> Ausbeute berechnen</p>' +
    '<p style="font-family:monospace; color:#7B1FA2;">Ausbeute = (' +
    act +
    ' / ' +
    theo +
    ') \u00d7 100%</p>' +
    ...
    '<p><strong>' +
    yield_pct.toFixed(2) +
    '%</strong> Ausbeute bedeutet, dass ' +
    yield_pct.toFixed(1) +
    '% der theoretisch m\u00f6glichen Produktmenge tats\u00e4chlich erhalten wurden.</p>' +
    (yield_pct < 50
      ? '<p style="color:#c62828;"><small>\u26a0\ufe0f <strong>Niedrige Ausbeute:</strong> Es k\u00f6nnten Probleme mit der Reaktion aufgetreten sein (Verunreinigungen, Nebenreaktionen, Verluste bei der Aufarbeitung).</small></p>'
      : '') +
    (yield_pct > 100
      ? '<p style="color:#c62828;"><small>\u26a0\ufe0f <strong>Ausbeute > 100%:</strong> Dies ist physikalisch unm\u00f6glich! M\u00f6gliche Ursachen: Verunreinigungen im Produkt, Feuchtigkeit, Messfehler.</small></p>'
      : '') +
    (yield_pct >= 80 && yield_pct <= 100
      ? '<p style="color:#2e7d32;"><small>\u2705 <strong>Gute Ausbeute:</strong> Die Reaktion verlief effizient.</small></p>'
      : '') +
    '</div>' +
    '</div>' +
    '<div style="margin-bottom:15px;">' +

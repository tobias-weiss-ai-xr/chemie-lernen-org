...
import { n as t, t as n } from "./performanceConfigurator-DMA6Ub5Z.js";
import { t as r } from "./logger-B7TbbsLc.js";
import { t as i } from "./shaderStore-CADv5V1N.js";
import { a, i as o, n as s, r as c, t as l } from "./precisionDate-bmQoyfr9.js";
import { t as u } from "./devTools-LMnNz6iC.js";
...
function C(e, t, n, r, i, a) {
	...
	let s = A(t, "vertex", r, o._contextWasLost), c = A(n, "fragment", r, o._contextWasLost);
	return a(e, s, c, r, i, o.validateShaderPrograms);
}
function w(e, t, n, r, i, a = null, o) {
	let s = x(i);
	o ||= s._createShaderProgramInjection ?? E;
	let c = s._webGLVersion > 1 ? "#version 300 es\n#define WEBGL2 \n" : "", l = k(t, "vertex", r, c, i, s._contextWasLost), u = k(n, "fragment", r, c, i, s._contextWasLost);
...
function te(e, t, n, r, i, a, o, s, c, l = "", u, d, f) {
	...
	let m = e;
	r ? m.program = d(m, t, n, m.context, c) : m.program = f(m, t, n, s, m.context, c), m.program.__SPECTOR_rebuildProgram = o, u();
}
function k(e, t, n, r, i, a) {
	return A(g(e, n, r), t, i, a);
}
function A(e, t, n, r) {
...
var ie = "attribute", ae = "varying", j = class {
	constructor() {
		this.children = [];
	}
	isValid(e) {
	...
	process(e, t, n) {
		...
		if (this.line) {
			...
			if (i) {
				...
				let r = t.processor?.attributeKeywordName ?? ie, a = t.isFragment && t.processor?.varyingFragmentKeywordName ? t.processor?.varyingFragmentKeywordName : !t.isFragment && t.processor?.varyingVertexKeywordName ? t.processor?.varyingVertexKeywordName : ae;
...
N.InfixToPostfixCacheLimitSize = 5e4, N.InfixToPostfixCacheCleanupSize = 25e3, N._InfixToPostfixCache = /* @__PURE__ */ new Map(), N._OperatorPriority = {
	")": 0,
	"(": 1,
	"||": 2,
	"&&": 3
...
}, de = /defined\s*?\((.+?)\)/g, F = /defined\s*?\[(.+?)\]/g, fe = /#include\s?<(.+)>(\((.*)\))*(\[(.*)\])*/g, pe = /__decl__/, I = /light\{X\}.(\w*)/g, L = /\{X\}/g, R = [], me = /(#ifdef)|(#else)|(#elif)|(#endif)|(#ifndef)|(#if)/;
function he(e) {
	e.processor && e.processor.initializeShaders && e.processor.initializeShaders(e.processingContext);
}
function z(e, t, n, r) {
	t.processor?.preProcessShaderCode && (e = t.processor.preProcessShaderCode(e, t.isFragment)), W(e, t, (e) => {
		t.processCodeAfterIncludes && (e = t.processCodeAfterIncludes(t.isFragment ? "fragment" : "vertex", e, t.defines)), n(xe(e, t, r), e);
	});
}
function ge(e, t, n) {
...
function B(e) {
	...
	if (i === -1) return new P(e);
	let a = e.substring(0, i).trim(), o = e.substring(i + r.length).trim();
	return new ue(a, r, o);
}
function ve(e) {
	e = e.replace(de, "defined[$1]");
	let t = N.infixToPostfix(e), n = [];
	for (let e of t) if (e !== "||" && e !== "&&") n.push(e);
	else if (n.length >= 2) {
		let t = n[n.length - 1], r = n[n.length - 2];
		n.length -= 2;
		let i = e == "&&" ? new le() : new ce();
		typeof t == "string" && (t = t.replace(F, "defined($1)")), typeof r == "string" && (r = r.replace(F, "defined($1)")), i.leftOperand = typeof r == "string" ? B(r) : r, i.rightOperand = typeof t == "string" ? B(t) : t, n.push(i);
	}
	let r = n[n.length - 1];
	return typeof r == "string" && (r = r.replace(F, "defined($1)")), typeof r == "string" ? B(r) : r;
}
function V(e, t) {
	let n = new se(), r = e.substring(0, t), i = e.substring(t);
	return i = i.substring(0, (i.indexOf("//") + 1 || i.length + 1) - 1).trim(), r === "#ifdef" ? n.testExpression = new P(i) : r === "#ifndef" ? n.testExpression = new P(i, !0) : n.testExpression = ve(i), n;
}
function H(e, t, n, r) {
	let i;
	for (; U(e, n, r);) {
...
function xe(e, t, n) {
	...
	let i = t.defines, a = be(t, n);
	t.processor.preProcessor && (r = t.processor.preProcessor(r, i, a, t.isFragment, t.processingContext));
	let o = {};
	return r = ye(r, a, t, o), t.processor.postProcessor && (r = t.processor.postProcessor(r, i, t.isFragment, t.processingContext, n ? { drawBuffersExtensionDisabled: !n.getCaps().drawBuffersExtension } : {}, a, o)), n?._features.needShaderCodeInlining && (r = n.inlineShaderCode(r)), r;
}
function W(e, t, n) {
	R.length = 0;
	let r;
	for (; (r = fe.exec(e)) !== null;) R.push(r);
	let i = [e], a = !1;
	for (let e of R) {
		let r = e[1];
		if (r.indexOf("__decl__") !== -1 && (r = r.replace(pe, ""), t.supportsUniformBuffers && (r = r.replace("Vertex", "Ubo").replace("Fragment", "Ubo")), r += "Declaration"), t.includesShadersStore[r]) {
			...
			if (e[4]) {
				...
				if (r.indexOf("..") !== -1) {
					...
					for (let e = i; e < a; e++) t.supportsUniformBuffers || (o = o.replace(I, (e, t) => t + "{X}")), n += o.replace(L, e.toString()) + "\n";
				} else t.supportsUniformBuffers || (n = n.replace(I, (e, t) => t + "{X}")), n = n.replace(L, r);
			}
			let o = [];
			for (let t of i) {
				let r = t.split(e[0]);
			...
			G.loadFile(e, (e) => {
				t.includesShadersStore[r] = e, W(i.join(""), t, n);
			});
			return;
		}
	}
	R.length = 0;
	let o = i.join("");
	a ? W(o.toString(), t, n) : n(o);
}
var G = { loadFile: (e, t, n, r, i, a) => {
	throw u("FileTools");
} };
//#endregion
...
function Ce(e, t, n, r, i, o, s) {
	let c, l, u = a() ? o?.getHostDocument() : null;
	c = typeof t == "string" ? t : t.vertexSource ? "source:" + t.vertexSource : t.vertexElement ? u?.getElementById(t.vertexElement) || t.vertexElement : t.vertex || t, l = typeof t == "string" ? t : t.fragmentSource ? "source:" + t.fragmentSource : t.fragmentElement ? u?.getElementById(t.fragmentElement) || t.fragmentElement : t.fragment || t;
	let d = [void 0, void 0], f = () => {
		if (d[0] && d[1]) {
			let [a, c] = d;
			he(e), z(a, e, (a, l) => {
				s && (s._vertexSourceCodeBeforeMigration = l), n && (a = n("vertex", a)), e.isFragment = !0, z(c, e, (o, c) => {
					s && (s._fragmentSourceCodeBeforeMigration = c), n && (o = n("fragment", o));
					let l = ge(a, o, e);
					e = null;
					let u = we(l.vertexCode, l.fragmentCode, t, i);
	...
	q(c, "Vertex", "", (e) => {
		s && (s._rawVertexSourceCode = e), d[0] = e, f();
	}, i), q(l, "Fragment", "Pixel", (e) => {
		s && (s._rawFragmentSourceCode = e), d[1] = e, f();
	}, i);
}
function q(e, t, n, r, a, o) {
	...
	let l;
	if (l = e[0] === "." || e[0] === "/" || e.indexOf("http") > -1 ? e : i.GetShadersRepository(a) + e, o ||= _, !o) throw Error("loadFileInjection is not defined");
...
var De = (e, t, n, r = 16, i = 3e4, a = !0, o) => {
	if (a && Y(e, t, n)) return null;
	let s = setInterval(() => {
		Y(e, t, n) ? clearInterval(s) : (i -= r, i < 0 && (clearInterval(s), n?.(/* @__PURE__ */ Error("Operation timed out after maximum retries. " + (o || "")), !0)));
	}, r);
	...
	constructor(n, r, i, a = null, o, s = null, c = null, l = null, u = null, d, f = "", p = 0, m) {
		this.defines = "", this.onCompiled = null, this.onError = null, this.onBind = null, this.uniqueId = 0, this.onCompileObservable = new e(), this.onErrorObservable = new e(), this._onBindObservable = null, this._isDisposed = !1, this._refCount = 1, this._bonesComputationForcedToCPU = !1, this._uniformBuffersNames = {}, this._multiTarget = !1, this._samplers = {}, this._isReady = !1, this._compilationError = "", this._allFallbacksProcessed = !1, this._uniforms = {}, this._key = "", this._fallbacks = null, this._vertexSourceCodeOverride = "", this._fragmentSourceCodeOverride = "", this._transformFeedbackVaryings = null, this._disableParallelShaderCompilation = !1, this._pipelineContext = null, this._vertexSourceCode = "", this._fragmentSourceCode = "", this._vertexSourceCodeBeforeMigration = "", this._fragmentSourceCodeBeforeMigration = "", this._rawVertexSourceCode = "", this._rawFragmentSourceCode = "", this._processCodeAfterIncludes = void 0, this._processFinalCode = null, this._onReleaseEffectsObserver = null, this.name = n, this._key = f;
		...
		this._engine.shaderPlatformName === "WEBGL2" && (g = Se(h, this._engine._gl) ?? g), this._attributeLocationByName = {}, this.uniqueId = t._UniqueIdSeed++, g ? (this._pipelineContext = g, this._pipelineContext.setEngine(this._engine), this._onRenderingStateCompiled(this._pipelineContext), this._pipelineContext.program && (this._pipelineContext.program.__SPECTOR_rebuildProgram = this._rebuildProgram.bind(this))) : this._processShaderCodeAsync(null, !1, null, m), this._onReleaseEffectsObserver = this._engine.onReleaseEffectsObservable.addOnce(() => {
			this._onReleaseEffectsObserver = null, !this.isDisposed && this.dispose(!0);
		});
	}
	async _processShaderCodeAsync(e = null, t = !1, n = null, r) {
		r && await r(), this._processingContext = n || this._engine._getShaderProcessingContext(this._shaderLanguage, !1), Ce({
	...
	_checkIsReady(e) {
		De(() => this._isReadyInternal() || this._isDisposed, () => {}, (t) => {
	...
	_onRenderingStateCompiled(e) {
		if (this._pipelineContext = e, this._pipelineContext.setEngine(this._engine), this._attributes = [], this._pipelineContext._fillEffectInformation(this, this._uniformBuffersNames, this._uniformsNames, this._uniforms, this._samplerList, this._samplers, this._attributesNames, this._attributes), this._attributesNames) for (let e = 0; e < this._attributesNames.length; e++) {
			let t = this._attributesNames[e];
			this._attributeLocationByName[t] = this._attributes[e];
		}
		this._engine.bindSamplers(this), this._compilationError = "", this._isReady = !0, this.onCompiled && this.onCompiled(this), this.onCompileObservable.notifyObservers(this), this.onCompileObservable.clear(), this._fallbacks && this._fallbacks.unBindMesh(), t.AutomaticallyClearCodeCache && this.clearCodeCache();
	}
	_prepareEffect(e = !1) {
	...
	_processCompilationErrors(e, n = null) {
	...
	bindUniformBuffer(e, n) {
		let r = this._uniformBuffersNames[n];
		r === void 0 || t._BaseCache[r] === e && this._engine._features.useUBOBindingCache || (t._BaseCache[r] = e, this._engine.bindUniformBufferBase(e, r, n));
	}
	...
	dispose(e = !1) {
		if (e) this._refCount = 0;
		else {
			if (t.PersistentMode) return;
			this._refCount--;
		}
		this._refCount > 0 || this._isDisposed || (this._onReleaseEffectsObserver &&= (this._engine.onReleaseEffectsObservable.remove(this._onReleaseEffectsObserver), null), this._pipelineContext && K(this._pipelineContext), this._engine._releaseEffect(this), this.clearCodeCache(), this._isDisposed = !0);
	}
...
var Q = class i {
	...
	get emptyTexture() {
		return this._emptyTexture ||= this.createRawTexture(new Uint8Array(4), 1, 1, 5, !1, !1, 1), this._emptyTexture;
	}
	get emptyTexture3D() {
		return this._emptyTexture3D ||= this.createRawTexture3D(new Uint8Array(4), 1, 1, 1, 5, !1, !1, 1), this._emptyTexture3D;
	}
	get emptyTexture2DArray() {
		return this._emptyTexture2DArray ||= this.createRawTexture2DArray(new Uint8Array(4), 1, 1, 1, 5, !1, !1, 1), this._emptyTexture2DArray;
	}
	...
	_isOverFrameTime(e) {
		...
		return this._lastFrameTime = e, this._renderAccumulator += t, this._renderAccumulator < this._minFrameTime ? !0 : (this._renderAccumulator -= this._minFrameTime, this._renderAccumulator > this._minFrameTime && (this._renderAccumulator = this._minFrameTime), !1);
	}
	_processFrame(e) {
	...
	getHostWindow() {
		return a() ? this._renderingCanvas && this._renderingCanvas.ownerDocument && this._renderingCanvas.ownerDocument.defaultView ? this._renderingCanvas.ownerDocument.defaultView : window : null;
	}
	...
	_createTextureBase(e, n, a, o, s = 3, c = null, l = null, u, d, f = null, m = null, h = null, g = null, _, v, y) {
		e ||= "";
		let b = e.substring(0, 5) === "data:", ee = e.substring(0, 5) === "blob:", x = b && e.indexOf(";base64,") !== -1, S = m || new p(this, 1);
		S !== m && (S.label = e.substring(0, 60));
		let C = e;
		this._transformTextureUrl && !x && !m && !f && (e = this._transformTextureUrl(e)), C !== e && (S._originalUrl = C);
		let w = e.lastIndexOf("."), T = g || (w > -1 ? e.substring(w).toLowerCase() : "");
		T.indexOf("?") > -1 && (T = T.split("?")[0]);
		let E = i.GetCompatibleTextureLoader(T, _);
		o && o.addPendingData(S), S.url = e, S.generateMipMaps = !n, S.samplingMode = s, S.invertY = a, S._useSRGBBuffer = this._getUseSRGBBuffer(!!y, n), this._doNotHandleContextLost || (S._buffer = f);
		let D = null;
		c && !m && (D = S.onLoadedObservable.add(c)), m || this._internalTexturesCache.push(S);
		let O = (i, a) => {
			o && o.removePendingData(S), e === C ? (D && S.onLoadedObservable.remove(D), t.UseFallbackTexture && e !== t.FallbackTexture && this._createTextureBase(t.FallbackTexture, n, S.invertY, o, s, null, l, u, d, f, S), i = (i || "Unknown error") + (t.UseFallbackTexture ? " - Fallback texture was used" : ""), S.onErrorObservable.notifyObservers({
				message: i,
				exception: a
			}), l && l(i, a)) : (r.Warn(`Failed to load ${e}, falling back to ${C}`), this._createTextureBase(C, n, S.invertY, o, s, c, l, u, d, f, S, h, g, _, v, y));
		};
		if (E) {
			let t = async (e) => {
				(await E).loadData(e, S, (e, t, n, r, i, a) => {
					a ? O("TextureLoader failed to load data") : u(S, T, o, {
						width: e,
						height: t
					}, S.invertY, !n, r, () => (i(), !1), s);
				}, v);
			};
			if (!f) this._loadFile(e, async (e) => {
				try {
					await t(new Uint8Array(e));
				} catch (e) {
				...
				f instanceof ArrayBuffer ? e(new Uint8Array(f)) : ArrayBuffer.isView(f) ? e(f) : l && l("Unable to load: only ArrayBuffer or ArrayBufferView is supported", null);
			}
		} else {
			let t = (e) => {
				ee && !this._doNotHandleContextLost && (S._buffer = e), u(S, T, o, e, S.invertY, n, !1, d, s);
			};
			!b || x ? f && (typeof f.decoding == "string" || f.close) ? t(f) : i._FileToolsLoadImage(e || "", t, O, o ? o.offlineProvider : null, _, S.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : typeof f == "string" || f instanceof ArrayBuffer || ArrayBuffer.isView(f) || f instanceof Blob ? i._FileToolsLoadImage(f, t, O, o ? o.offlineProvider : null, _, S.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : f && t(f);
		}
		return S;
	}
	_rebuildBuffers() {
	...
	getHostDocument() {
		return this._renderingCanvas && this._renderingCanvas.ownerDocument ? this._renderingCanvas.ownerDocument : c() ? document : null;
	}
	...
	constructor(r, i, s) {
		this._colorWrite = !0, this._colorWriteChanged = !0, this._depthCullingState = new Oe(), this._stencilStateComposer = new ke(), this._stencilState = new Z(), this._alphaState = new Ae(!1), this._alphaMode = Array(8).fill(-1), this._alphaEquation = Array(8).fill(-1), this._activeRequests = [], this._badOS = !1, this._badDesktopOS = !1, this._compatibilityMode = !0, this._internalTexturesCache = [], this._currentRenderTarget = null, this._boundTexturesCache = {}, this._activeChannel = 0, this._currentTextureChannel = -1, this._viewportCached = {
			x: 0,
			y: 0,
			z: 0,
			w: 0
		}, this._isWebGPU = !1, this._enableGPUDebugMarkers = !1, this.onCanvasBlurObservable = new e(), this.onCanvasFocusObservable = new e(), this.onNewSceneAddedObservable = new e(), this.onResizeObservable = new e(), this.onCanvasPointerOutObservable = new e(), this.onEffectErrorObservable = new e(), this.disablePerformanceMonitorInBackground = !1, this.disableVertexArrayObjects = !1, this._frameId = 0, this.hostInformation = { isMobile: !1 }, this.isFullscreen = !1, this.enableOfflineSupport = !1, this.disableManifestCheck = !1, this.disableContextMenu = !0, this.currentRenderPassId = 0, this.isPointerLock = !1, this.postProcesses = [], this.canvasTabIndex = 1, this._contextWasLost = !1, this._useReverseDepthBuffer = !1, this.isNDCHalfZRange = !1, this.hasOriginBottomLeft = !0, this._renderTargetWrapperCache = [], this._compiledEffects = {}, this._isDisposed = !1, this.scenes = [], this._virtualScenes = [], this.onBeforeTextureInitObservable = new e(), this.renderEvenInBackground = !0, this.preventCacheWipeBetweenFrames = !1, this._frameHandler = 0, this._activeRenderLoops = [], this._windowIsBackground = !1, this._boundRenderFunction = (e) => this._renderLoop(e), this._lastFrameTime = 0, this._renderAccumulator = 0, this.skipFrameRender = !1, this.onBeforeShaderCompilationObservable = new e(), this.onAfterShaderCompilationObservable = new e(), this.onBeginFrameObservable = new e(), this.onEndFrameObservable = new e(), this._transformTextureUrl = null, this._uniformBuffers = [], this._storageBuffers = [], this._highPrecisionShadersAllowed = !0, this.onContextLostObservable = new e(), this.onContextRestoredObservable = new e(), this._name = "", this.premultipliedAlpha = !0, this.adaptToDeviceRatio = !1, this._lastDevicePixelRatio = 1, this._doNotHandleContextLost = !1, this.cullBackFaces = null, this._renderPassNames = ["main"], this._fps = 60, this._deltaTime = 0, this._deterministicLockstep = !1, this._lockstepMaxSteps = 4, this._timeStep = 1 / 60, this.onDisposeObservable = new e(), this.onReleaseEffectsObservable = new e(), t.Instances.push(this), this.startTime = l.Now, this._stencilStateComposer.stencilGlobal = this._stencilState, n.SetMatrixPrecision(!!i.useLargeWorldRendering || !!i.useHighPrecisionMatrix), o() && navigator.userAgent && (this._badOS = /iPad/i.test(navigator.userAgent) || /iPhone/i.test(navigator.userAgent), this._badDesktopOS = /^((?!chrome|android).)*safari/i.test(navigator.userAgent)), this.adaptToDeviceRatio = s ?? !1, i.antialias = r ?? i.antialias, i.deterministicLockstep = i.deterministicLockstep ?? !1, i.lockstepMaxSteps = i.lockstepMaxSteps ?? 4, i.timeStep = i.timeStep ?? 1 / 60, i.stencil = i.stencil ?? !0, this._audioContext = i.audioEngineOptions?.audioContext ?? null, this._audioDestination = i.audioEngineOptions?.audioDestination ?? null, this.premultipliedAlpha = i.premultipliedAlpha ?? !0, this._doNotHandleContextLost = !!i.doNotHandleContextLost, this._isStencilEnable = !!i.stencil, this.useExactSrgbConversions = i.useExactSrgbConversions ?? !1;
		let c = a() && window.devicePixelRatio || 1, u = i.limitDeviceRatio || c;
		s = s || i.adaptToDeviceRatio || !1, this._hardwareScalingLevel = s ? 1 / Math.min(u, c) : 1, this._lastDevicePixelRatio = c, this._creationOptions = i;
	}
	resize(e = !1) {
		let t, n;
		if (this.adaptToDeviceRatio) {
			let e = a() && window.devicePixelRatio || 1, t = this._lastDevicePixelRatio / e;
			this._lastDevicePixelRatio = e, this._hardwareScalingLevel *= t;
		}
		if (a() && c()) if (this._renderingCanvas) {
	...
	_setupMobileChecks() {
		navigator && navigator.userAgent && (this._checkForMobile = () => {
			...
			this.hostInformation.isMobile = e.indexOf("Mobile") !== -1 || e.indexOf("Mac") !== -1 && c() && "ontouchend" in document;
		}, this._checkForMobile(), a() && window.addEventListener("resize", this._checkForMobile));
	}
	...
	dispose() {
		...
		this._boundRenderFunction = null, this.onDisposeObservable.notifyObservers(this), this.onDisposeObservable.clear(), this.onResizeObservable.clear(), this.onCanvasBlurObservable.clear(), this.onCanvasFocusObservable.clear(), this.onCanvasPointerOutObservable.clear(), this.onNewSceneAddedObservable.clear(), this.onEffectErrorObservable.clear(), a() && window.removeEventListener("resize", this._checkForMobile);
		let e = t.Instances.indexOf(this);
		e >= 0 && t.Instances.splice(e, 1), t.Instances.length || (t.OnEnginesDisposedObservable.notifyObservers(this), t.OnEnginesDisposedObservable.clear()), this.onBeginFrameObservable.clear(), this.onEndFrameObservable.clear();
	}
	static DefaultLoadingScreenFactory(e) {
		throw u("LoadingScreen");
	}
	static MarkAllMaterialsAsDirty(e, n) {
		for (let r = 0; r < t.Instances.length; r++) {
			let i = t.Instances[r];
			for (let t = 0; t < i.scenes.length; t++) i.scenes[t].markAllMaterialsAsDirty(e, n);
		}
	}
...
Q._RenderPassIdCounter = 0, Q._RescalePostProcessFactory = null, Q.CollisionsEpsilon = .001, Q.QueueNewFrame = je;
//#endregion
...
//#endregion
export { p as A, w as C, g as D, h as E, v as O, C as S, x as T, O as _, Pe as a, ne as b, X as c, K as d, z as f, re as g, E as h, Ne as i, d as j, y as k, Ee as l, G as m, Ie as n, Q as o, W as p, Me as r, Ae as s, $ as t, De as u, D as v, S as w, T as x, te as y };

//# sourceMappingURL=tools.functions-Dgi_rE0R.js.map
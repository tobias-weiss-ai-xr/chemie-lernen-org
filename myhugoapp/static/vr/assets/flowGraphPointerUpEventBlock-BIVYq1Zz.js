...
var a = class extends i {
	constructor(e) {
		super(e), this.type = "PointerUp", this.targetMesh = this.registerDataInput("targetMesh", n, e?.targetMesh), this.pointerId = this.registerDataOutput("pointerId", t), this.pickedMesh = this.registerDataOutput("pickedMesh", n), this.pickedPoint = this.registerDataOutput("pickedPoint", n);
	}
	_executeEvent(e, t) {
...
e("FlowGraphPointerUpEventBlock", a);
//#endregion
export { a as FlowGraphPointerUpEventBlock };

//# sourceMappingURL=flowGraphPointerUpEventBlock-BIVYq1Zz.js.map
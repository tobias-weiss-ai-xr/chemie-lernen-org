...
import { t } from "./math.color-BS-ZqBtl.js";
import { t as n } from "./constants-bT98KaZq.js";
//#region node_modules/@babylonjs/loaders/glTF/2.0/pbrMaterialLoadingAdapter.js
var r = class {
	constructor(e) {
	...
	set baseDiffuseRoughness(e) {
		this._material.baseDiffuseRoughness = e, e > 0 && (this._material.brdf.baseDiffuseModel = n.MATERIAL_DIFFUSE_MODEL_E_OREN_NAYAR);
	}
	...
	enableSpecularEdgeColor(e = !1) {
		e && (this._material.brdf.dielectricSpecularModel = n.MATERIAL_DIELECTRIC_SPECULAR_MODEL_OPENPBR, this._material.brdf.conductorSpecularModel = n.MATERIAL_CONDUCTOR_SPECULAR_MODEL_OPENPBR);
	}
	...
	set coatColor(e) {
		this._material.clearCoat.isTintEnabled = e != t.White(), this._material.clearCoat.tintColor = e;
	}
	...
	set transmissionDepth(e) {
		this.transmissionWeight > 0 ? this._material.subSurface.tintColorAtDistance = e : this.subsurfaceWeight > 0 && this._material.subSurface.diffusionDistance.multiplyInPlace(new t(e, e, e));
	}
	...
	get transmissionColor() {
		return this.transmissionWeight > 0 ? this._material.subSurface.tintColor : this.subsurfaceWeight > 0 ? this._material.subSurface.diffusionDistance : new t(0, 0, 0);
	}
	...
	set subsurfaceColor(n) {
		let r = new e(-Math.log(this.transmissionColor.r), -Math.log(this.transmissionColor.g), -Math.log(this.transmissionColor.b));
		r.scaleInPlace(1 / Math.max(this.transmissionDepth, .001));
		let i = r, a = Math.max(i.x, Math.max(i.y, i.z)), o = a > 0 ? 1 / a : 1;
		this._material.subSurface.diffusionDistance = new t(Math.exp(-i.x * o), Math.exp(-i.y * o), Math.exp(-i.z * o));
	}
	...
	get subsurfaceRadiusScale() {
		return this._material.subSurface.scatteringDiffusionProfile ?? t.White();
	}
...
//# sourceMappingURL=pbrMaterialLoadingAdapter-DQ9-QDyy.js.map